...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 md:py-32 px-6 overflow-hidden bg-gradient-to-br from-primary via-primary-light to-sky">
      {/* Geometric accent */}
      ...
      <div ref={ref} className="relative z-10 max-w-2xl mx-auto text-center fade-in-section">
        <p className="text-sky/80 font-semibold text-sm tracking-[0.2em] uppercase mb-3">
          Get In Touch
        </p>
        ...
        <a
          ...
          className="inline-flex items-center px-8 py-3.5 bg-accent text-white font-semibold rounded-lg shadow-lg shadow-black/15 hover:bg-accent-warm hover:shadow-black/25 hover:scale-[1.02] transition-all duration-200 mb-10"
        >
          Start a Conversation
        </a>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-white/60 text-sm font-light">
